...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DirhamCount_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_DirhamCount;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APickup_Statics::NewProp_DirhamCount_MetaData[] = {
		{ "Category", "Dirhams" },
		{ "Comment", "//Variables\n" },
		{ "ModuleRelativePath", "Pickup.h" },
		{ "ToolTip", "Variables" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_APickup_Statics::NewProp_DirhamCount = { "DirhamCount", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APickup, DirhamCount), METADATA_PARAMS(Z_Construct_UClass_APickup_Statics::NewProp_DirhamCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APickup_Statics::NewProp_DirhamCount_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APickup_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APickup_Statics::NewProp_DirhamCount,
	};
	...
	IMPLEMENT_CLASS(APickup, 3170594624);
